...
<html lang="en">
  ...
  <body>
    ...
    <!-- HERO -->
    <div class="container-fluid vh-90 px-0 mx-0 row">
      <div class="col-3"></div>
    ...
    <!-- Previews Section -->
    <div class="container-fluid px-0 mx-0 row previews">
      <div class="col-3"></div>
      <div class="col">
        <div>
          <div class="rect27 mb-5">
            <div class="rect28"></div>
            <div class="rect29"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- CTA Section -->
    <div class="container-fluid px-0 mx-0 row py-max">
      <div class="col-3"></div>
      <div class="col">
        <h1 class="mxw-400">
    ...
    <!-- Gallery Section -->
    <div class="container-fluid mx-0 row py-max pb-200 pl-100">
      <div class="col">
        <h1>Gallery</h1>
        <div class="d-flex">
          <img src="assets/Rectangle42.png" class="m-1" />
          <img src="assets/Rectangle42.png" class="m-1" />
          <img src="assets/Rectangle42.png" class="m-1" />
          <img src="assets/Rectangle42.png" class="m-1" />
          <img src="assets/Rectangle42.png" class="m-1" />
    ...
    <footer class="container-fluid mx-0 px-0">
      <div class="d-flex justify-content-between foot py-max px-max">
